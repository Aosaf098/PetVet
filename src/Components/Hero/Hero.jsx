...
const Hero = () => {
  return (
    <>
      <div>
        <div className="lg:w-2/3 mx-auto lg:my-16 my-10 flex lg:flex-row flex-col items-center relative">
          <div className="lg:w-1/2 lg:h-[600px] lg:p-4 px-8 flex gap-10 flex-col lg:py-28">
            <h1 className="text-5xl font-bold leading-snug">
              ...
              <span className="bg-green-400 px-3 rounded-sm">Vets!</span>
            </h1>
            ...
            <Button className="bg-green-500 lg:w-1/3 w-1/2 p-3 py-6">
              Book an Appointment
            </Button>
          </div>
